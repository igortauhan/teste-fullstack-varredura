...
public class SearchController {
    ...
    public ResponseEntity<List<Records>> search(@RequestParam Long ativoId, @RequestParam String pattern) {
        ...
        List<Records> records = searchService.search(pattern, ativoId);
